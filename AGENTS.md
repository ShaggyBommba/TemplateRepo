...
Bootstrap instructions for coding agents working in this layered service
template. See `docs/architecture.md` for the repository structure, component
patterns, and layer boundaries.
...
`docs/workflows.md` is relevant. For template architecture documentation,
`docs/architecture.md` is relevant.
...
- `docs/architecture.md` defines template architecture, models, ports, APIs,
  workflows, and implementation state.
...
4. `docs/architecture.md` for template architecture and implementation state.
